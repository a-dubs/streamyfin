...
/**
 * Generates a device profile for downloading with optional max height constraint
 * @param maxHeight - Optional maximum video height for transcoding
 */
export const generateDownloadProfile = ({ maxHeight } = {}) => {
  const profile = {
    Name: "1. Vlc Player",
...
// Backwards compatibility - export as default
